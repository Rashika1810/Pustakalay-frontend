        ...
        <form>
          ...
          <div className="bg-white shadow-2xl rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2 text-amber-700">
            ...
            <div className='flex justify-center '>
              <button onClick={handleStudentRegister} type='button' className='border-2 rounded-2xl p-2 hover:bg-amber-700 hover:text-amber-50 border-amber-700 text-amber-800 text-center w-20'>Submit</button>
            </div>
          </div>
        </form>
      </div>
